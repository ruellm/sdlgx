...
void CaseFileScrollBox::SetCoordinates(int x, int y)
{
	...
	_bar.SetCoordinates(x + 776, y + 27);
	_window_X_offset = 25;
	_window_Y_offset = 27;
	_viewport_height = _bg.GetHeight() - (27 + 27);
	...
	int count)
{
	...
	sdlgx::scene::SDLGX_DrawText(10, 10,
		"Test", FONT_MYRIADPRO_REGULAR, 30, { 255,255,255 });

	sdlgx::scene::SDLGX_DrawText(10, 40,
		"The quick brown fox", FONT_MYRIADPRO_REGULAR, 30, { 255,255,255 });

	sdlgx::scene::SDLGX_DrawText(10, 90,
		"Are you crazy?", FONT_MYRIADPRO_REGULAR, 30, { 255,255,255 });
...
void LogScrollBox::Load()
{
	...
	sdlgx::scene::SDLGX_DrawText(10, 10,
		"Test", FONT_MYRIADPRO_REGULAR, 50, { 255,255,255 });

	sdlgx::scene::SDLGX_DrawText(10, 70,
		"The quick brown fox", FONT_MYRIADPRO_REGULAR, 50, { 255,255,255 });

	sdlgx::scene::SDLGX_DrawText(10, 140,
		"Are you crazy?", FONT_MYRIADPRO_REGULAR, 50, { 255,255,255 });
